...
class NewUserMiddleware(BaseMiddleware):
    ...
    async def self_welcome(message: Message):
        doc = Doc(
            _("Hi, Thank you for choosing Macela for your group!"),
            _("Please read the documentation to learn more about Macela and do not hesitate to join the Support Chat"),
        )
